...
export const PROJECT_OPERATIONAL_TRANSITIONS: readonly OperationalTransition[] = [
  ...
  { from: 'ready', to: 'ready', actionId: 'add-buildings', requires: ['project exists', 'server-created-building'], risk: 'low', reversible: true },
  { from: 'ready', to: 'ready', actionId: 'add-apartments', requires: ['project exists', 'server-created-apartment'], risk: 'low', reversible: true },
...
export const APARTMENT_OPERATIONAL_TRANSITIONS: readonly OperationalTransition[] = [
  ...
  { from: 'incomplete', to: 'incomplete', actionId: 'define-physical-specs', requires: ['apartment exists', 'valid physical data'], risk: 'low', reversible: true },
  { from: 'incomplete', to: 'incomplete', actionId: 'define-commercial-data', requires: ['apartment exists', 'server persistence'], risk: 'high', reversible: true },
  { from: 'incomplete', to: 'ready', actionId: 'define-availability', requires: ['availability represented by supported apartment status'], risk: 'high', reversible: true },
  { from: 'ready', to: 'ready', actionId: 'upload-plans-media', requires: ['apartment exists', 'media endpoint available'], risk: 'medium', reversible: true },
  { from: 'ready', to: 'in-progress', actionId: 'publish', requires: ['publishable completeness', 'server confirmation'], risk: 'high', reversible: true },
  { from: 'in-progress', to: 'completed', actionId: 'publish-success', requires: ['server confirmation'], risk: 'high', reversible: true },
  { from: 'in-progress', to: 'failed', actionId: 'publish-failure', requires: ['recoverable server/network error'], risk: 'high', reversible: true },
  { from: 'completed', to: 'completed', actionId: 'unpublish', requires: ['server-supported published=false mutation'], risk: 'high', reversible: true },
