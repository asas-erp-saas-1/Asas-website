...
// Keep semantic tokens here; component-specific business values belong elsewhere.
...
// Backward-compatible aliases for consumers that still reference the old token shape.
export const legacyColors = {
  forest: { DEFAULT: colors.brand.forest, light: colors.brand.forestLight, dark: colors.brand.forestDark },
  charcoal: { DEFAULT: colors.brand.charcoal },
  ivory: { DEFAULT: colors.brand.ivory },
  sand: { DEFAULT: colors.brand.sand },
  gold: { DEFAULT: colors.brand.gold },
} as const;
...
export const shadows = {
  ...
  elevated: '0 12px 28px rgb(0 0 0 / 0.10)',
  overlay: '0 20px 48px rgb(0 0 0 / 0.16)',
} as const;
