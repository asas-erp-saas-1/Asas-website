...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!apartment || apartment.project?.slug !== slug) {
    return {
      title: 'Appartement introuvable | ASAS',
  ...
  const description = apartment.description?.trim() ||
    `${apartment.typeName} de ${apartment.surface} m² à ${projectName}. Consultez les détails, le plan et les disponibilités auprès d'ASAS.`;
