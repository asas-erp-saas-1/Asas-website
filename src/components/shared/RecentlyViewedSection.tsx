...
export function RecentlyViewedSection(){
 ...
 const sortedApartments=useMemo<Apartment[]>(()=>{if(!apartments)return [];return effectiveIds.flatMap(id=>{const apartment=apartments.find(a=>a.id===id);return apartment?[apartment]:[];});},[apartments,effectiveIds]);
 ...
 const handleView=(apartment:Apartment)=>{const projectSlug=apartment.project?.slug??'';if(projectSlug)router.goApartment(projectSlug,apartment.slug);};
